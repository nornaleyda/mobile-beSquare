...
//   void _getCurrentWeatherData(String GetWeather) async {
//     final response = await http.get(Uri.parse(
//         'https://api.openweathermap.org/data/2.5/weather?q=GetWeather&appid=ad34a8fa990b40bba5333c0faf42d0a6'));
...
//       String getWeather = location;
//       await Future.delayed(const Duration(seconds: 1));

//       emit(WeatherStateLoaded(GetWeather));
//     }
//   }
// }
